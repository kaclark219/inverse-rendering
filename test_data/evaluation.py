...
DEFAULT_PRED_CSV = Path(__file__).resolve().parent / "test_predictions.csv"
...
def run_evaluation(pred_csv: Path, actual_csv: Path, out_dir: Path) -> None:
	...
	weights = {
		"light_type_classifier": 0.25,
		"light_count_detector": 0.20,
		"color_power_predictor": 0.20,
		"spot_size_predictor": 0.15,
		"energy_head": 0.20,
	}
